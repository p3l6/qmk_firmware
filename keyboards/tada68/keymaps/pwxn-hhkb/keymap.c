...
[_BL] = LAYOUT_65_ansi_split_backspace_hack(
    ...
    XXXXXXX, KC_LALT, KC_LGUI,                   KC_SPC,                             KC_RGUI, KC_RCTL, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT),
...
[_NL] = LAYOUT_65_ansi_split_backspace_hack(
    ...
    XXXXXXX, _______, _______,                   _______,                            _______, _______, XXXXXXX, __xxx__, __xxx__, __xxx__),
...
[_ML] = LAYOUT_65_ansi_split_backspace_hack(
    ...
    XXXXXXX, __xxx__, __xxx__,                   __xxx__,                            __xxx__, __xxx__, XXXXXXX, _______, _______, _______),
};
