...
#define XXXXXXX KC_NO // this represents an optional layout that has no key

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

  // Are all the missing keys places correctly? 
  // Combine ctrl with hide
  // Light bar!
  // BL_TOGG, etc: needed? keyboard has no backlight
...
[_BL] = LAYOUT(
    ...
    XXXXXXX,          KC_LALT, KC_LGUI,          KC_SPC,           XXXXXXX,          KC_RGUI, KC_RCTL,          XXXXXXX,  KC_LEFT, KC_DOWN, KC_RGHT),
...
[_FL] = LAYOUT(
    ...
    XXXXXXX,          _______, _______,          KC_ENT,           XXXXXXX,          _______, KC_NO,            XXXXXXX,  KC_MS_L, KC_MS_D, KC_MS_R),

[_NL] = LAYOUT(
    _______,          _______, _______, _______, _______, _______, _______, KC_PSLS, KC_PAST, KC_PMNS, _______, _______,  _______, _______, XXXXXXX, _______,
    ...
    XXXXXXX,          _______, _______,          KC_P0,            XXXXXXX,          KC_PDOT, _______,          XXXXXXX,  _______, _______, _______),
};
